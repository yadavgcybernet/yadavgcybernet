...
[![Email](https://img.shields.io/badge/Email-yadavg.cybernet%40gmail.com-D14836?style=flat&logo=gmail&logoColor=white)](mailto:yadavg.cybernet@gmail.com)
...
Motivated IT professional with **5+ years of combined experience** in technical support, network operations, and information security auditing. Holds an **MSc in IT and Applied Security** (London Metropolitan University / Islington College) with a specialisation in Computer Networking and Cybersecurity.

Experienced in troubleshooting connectivity issues, supporting end users, configuring network devices, and working within NOC and IS audit environments. Familiar with Windows operating systems, Active Directory, Microsoft 365, Azure, and remote support tools.
...
- L1 & L2 end-user technical support
- Troubleshooting internet, LAN, Wi-Fi, IPTV issues
- Remote support: TeamViewer · AnyDesk · RDP
- Ticket logging and CRM system management
- Router, switch, and firewall configuration
- Escalation handling and incident documentation

### Networking & Infrastructure
- TCP/IP · DNS · DHCP · VPN · LAN/WAN
- Network monitoring: Nagios · iMaster NCE
- ISP backbone fault resolution
- NOC operations and incident escalation
...
| Microsoft 365 & Exchange Online | Proficient |
| Microsoft Azure (user/VM management) | Fundamentals |
| Hyper-V / VMware | Awareness |
| Veeam / Acronis backup | Awareness |
...
- Reviewed IT systems, network infrastructure, and security configurations across **banks, insurance companies, ISPs, IT firms, and government bodies**
- Supported **ISO 27001** compliance checks by reviewing policies, procedures, and system configurations
- Prepared clear audit reports for both IT staff and non-technical stakeholders including senior management and board members
- Assisted in reviewing and improving IT policies and Standard Operating Procedures (SOPs) for multiple client organisations
- Conducted technical reviews of networks, operating systems, databases, and cloud environments to identify security risks
- Coordinated **Government Enterprise Architecture (GEA)** audit activities across government organisations
- Delivered internal **cybersecurity awareness sessions** to non-technical staff
...
- Configured and maintained routers, switches, and firewalls supporting **ISP backbone operations**
- Monitored network performance using **Nagios** and **iMaster NCE**, coordinating with NOC team to restore service outages
- Conducted **Root Cause Analysis (RCA)** for recurring technical incidents, reducing repeat call volumes
- Applied basic firewall rules and access control settings to maintain infrastructure security
- Mentored Level 1 support team members through knowledge sharing and on-the-job guidance
- Maintained accurate technical documentation, incident logs, and troubleshooting guides
...
- Managed customer enquiries using CRM systems with accurate logging and timely escalation
- Configured wireless routers, Wi-Fi repeaters, and IPTV devices for residential and small business customers
...
- Coordinated with field technicians for on-site service resolutions and customer follow-up
...
- Supported basic CCTV and cable TV device configuration and connectivity troubleshooting
...
**MSc Relevant Modules:** Cybersecurity Management · Network Security · Information Systems Audit · Risk Assessment · IoT Security · Applied Cryptography

**Dissertation:** *"Securing Insurance Companies: A Strategic Approach to ISO 27001 – ISMS Implementation"* — independently researched, 0% plagiarism score
...
- 🏢 **Multi-sector exposure** — IT environments across 4+ regulated industries: banking, insurance, ISPs, and government
...
```
Operating Systems   Windows 10/11 · Windows Server 2016/2019/2022 · Linux (Ubuntu, CentOS)
Networking          TCP/IP · DNS · DHCP · VPN · Nagios · iMaster NCE · LAN/WAN
Remote Support      TeamViewer · AnyDesk · RDP
